        ...
        child: Column(
          children: [
            Text(
              ...
              'رَبَّنَا آتِنَا فِي الدُّنْيَا حَسَنَةً وَفِي الآخِرَةِ حَسَنَةً وَقِنَا عَذَابَ النَّارِ وَصَلَّى اللهُ عَلَى سَيِّدِنَا وَنَبِيِّنَا مُحَمَّدٍ وَعَلَى آلِهِ وَأَصْحَابِهِ الأَخْيَارِ وَسَلَّمَ تَسْلِيمًا كَثِير',
              textAlign: TextAlign.justify,
              style: AppTextStyles.regular18.copyWith(
                height: 1.8,
                fontFamily: 'UthmanicHafs', // Using standard font or fallback
                fontSize: 20.sp,
              ),
            ),
          ],
